...
open class KeyDef(
    ...
    sealed class Appearance(
        ...
        /**
         * Horizontal dual-letter key with optional swipe hints.
         * Primary on the left, secondary on the right; smaller hints at top/bottom.
         */
        class HorizontalSuretype(
            ...
            val swipeLeftHint: String? = null,
            val swipeRightHint: String? = null,
            textSize: Float,
