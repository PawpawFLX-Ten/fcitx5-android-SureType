...
开发纯粹基于VibeCoding，主力为OpenCode+DeepSeek V4 Pro和Cursor。如果没有AI恶意植入，应该不涉及到泄露隐私的问题。
...
1. 先安装 `releases/HandJump-main-arm64-release.apk`（主程序）
2. 再安装 `releases/HandJump-rime-arm64-release.apk`（Rime 插件）
3. 进入大肥肠偷人法
...
5. 在系统设置中启用输入法，并在大肥肠偷人法的“输入法”中删除拼音，改为“中州韵”
 <img width="540" height="1200" alt="a4689bded234d2ed5d4b284e15883b9e" src="https://github.com/user-attachments/assets/2e2acadb-8f1e-4abf-81a0-83cc085c7d50" />

6. 在主题中勾选启用按键边框
<img width="540" height="1200" alt="91995ebdfde23a5c74d5a331e49fbac1" src="https://github.com/user-attachments/assets/5e96f313-2cf1-448f-b65c-4f6849acc17c" />

7. 点击地球标，切换到中州韵，
8. 键盘左上方的>键，在弹出的键盘中点击...唤出快速菜单
9. 点击**重载配置**
10. 重启手机
11. 在菜单第二行第一个图表中可以切换按键布局和输入方式（图有误，没有英文模式）
<img width="540" height="741" alt="21e8a6d58b037726db09dc0b2310f8b0" src="https://github.com/user-attachments/assets/f4a91ea1-b929-44fa-8705-8ac1b9deb272" />
12. Suffer from 大肥肠偷人法！
<img width="540" height="602" alt="ad08a224c7263ce289337c5290b0d57d" src="https://github.com/user-attachments/assets/9f26c24c-3a6a-4d24-a701-de2099f51be5" />
